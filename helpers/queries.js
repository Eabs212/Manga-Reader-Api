...
let queries = {
    general: {
        ...
        deleteManga: new PS('delete-manga', "DELETE FROM manga WHERE manga_id = $1 AND user_id = $2"),
        ...
        newCommentChapter: new PS('new-comment-manga', "INSERT INTO comments_chapter (user_id, chapter_id, comment_content, comment_creation_time) VALUES ($1, $2, $3, now())"),
        ...
        dislikeChapter: new PS('dislike-chapter', "DELETE FROM likes_chapter WHERE user_id = $1 AND chapter_id = $2"),        
        deleteChapter: new PS('delete-chapter', "DELETE FROM chapters WHERE manga_id = $1 AND chapter_id = $2"),
        deleteMangaComment: new PS('delete-manga-comment', "DELETE FROM comments_manga WHERE user_id = $1 AND manga_id = $2 AND comment_id = $3"),
        deleteChapterComment: new PS('delete-chapter-comment', "DELETE FROM comments_chapter WHERE user_id = $1 AND chapter_id = $2 AND comment_id = $3"),                
