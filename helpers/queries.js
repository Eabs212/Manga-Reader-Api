...
let queries = {
    general: {
        ...
        getLikesChapter: new PS('get-likes-chapter', "select COUNT(*) as likes, chapter_id from likes_chapter WHERE chapter_id = $1 GROUP BY chapter_id"),
        getChapterManga: new PS('get-chapter-manga',"SELECT * FROM chapters WHERE manga_id = $1 AND chapter_id = $2"),
    }
}
